...
export function SavingGoalAddDialog({
  goal,
  mobile,
  onClose,
}: SavingGoalAddDialogProps) {
  ...
  const Footer = (
    <ModalFooter
      ...
      saving={
        createMut.isPending || updateMut.isPending || contributeMut.isPending
      }
