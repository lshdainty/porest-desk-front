...
export const LabelManagementDialog = ({
  open,
  onClose,
  ...
  const handleSave = () => {
    ...
    if (editingLabel) {
      updateLabel.mutate(
        {
          id: editingLabel.rowId,
          data: { labelName: formName.trim(), color: formColor },
        },
        { onSuccess: resetForm },
      );
    } else {
          ...
          : labels.map((label) => (
              ...
              >
                <span
                  ...
                  style={{
                    backgroundColor: getPaletteByColor(label.color).color,
                  }}
                />
