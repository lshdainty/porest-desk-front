    ...
    >
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(165deg, #0d1430 0%, #17224a 60%, #1f2c5e 100%)",
          height: 240,
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <div
          style={{
            ...
            filter: collected
              ? "drop-shadow(0 0 10px rgba(176,196,255,0.55))"
              : "none",
          }}
        >
          <ConstellationSVG
      ...
      <div style={{ padding: "16px 4px 4px" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
          ...
          >
            {t("collection.starCount", {
              count: entry.constellation.starCount,
            })}
          </span>
        </div>
        <div
          style={{ fontSize: 13, color: "var(--fg-secondary)", marginTop: 4 }}
        >
          {description}
        </div>
        <div
