...
export function NightSkyHero({
  ...
  const map = useMemo(
    () => parseStarMap(today.constellation.starMap),
    [today.constellation.starMap],
  );
  ...
  const lineColor = done
    ? "rgba(178, 197, 255, 0.85)"
    : "rgba(148, 168, 235, 0.5)";
  ...
  const caption = done
    ...
    : doneToday > 0 || today.memoPoints > 0
      ? [
          ...
          today.memoPoints > 0
            ? t("hero.captionMemo", { count: today.memoPoints })
            : null,
  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(155deg, #0d1430 0%, #17224a 55%, #1f2c5e 100%)",
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            "radial-gradient(circle, rgba(154,176,255,0.16) 0%, transparent 65%)",
        }}
      />
      <span
        style={{
