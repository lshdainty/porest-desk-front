    ...
    >
      ...
      >
        ...
        {t("collection.progress", {
          collected: collection.collectedKinds,
  ...
  const rows = (
    <div>
      {collection.entries.map((entry, i) => {
        ...
        const description = constellationDesc(
          entry.constellation,
          i18n.language,
        );
        return (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                ...
                {key === newestKey && owned && (
                  <span className="fcol-badge fcol-badge--new">
                    {t("collection.badgeNew")}
                  </span>
                )}
                {owned && (
                  <span className="fcol-badge fcol-badge--own">
                    {t("collection.timesCollected", {
                      count: entry.collectCount,
                    })}
                  </span>
                )}
              </div>
              ...
              >
                {owned
                  ? description
                  : t("collection.lockedDesc", {
                      count: entry.constellation.starCount,
                    })}
              </div>
              <button
                type="button"
