...
const INCLUDES: {
  ...
  {
    v: "tx",
    lKey: "dialog.include.tx.l",
    dKey: "dialog.include.tx.d",
    Icon: Receipt,
  },
  {
    v: "cat",
    lKey: "dialog.include.cat.l",
    dKey: "dialog.include.cat.d",
    Icon: PieChart,
  },
  {
    v: "budget",
    lKey: "dialog.include.budget.l",
    dKey: "dialog.include.budget.d",
    Icon: Target,
  },
  {
    v: "asset",
    lKey: "dialog.include.asset.l",
    dKey: "dialog.include.asset.d",
    Icon: Wallet,
  },
];
...
export function ExportDialog({
  ...
  const [includes, setIncludes] = useState<IncludeKey[]>([
    "tx",
    "cat",
    "budget",
  ]);
  ...
  const toggle = (v: IncludeKey) =>
    setIncludes(
      includes.includes(v) ? includes.filter((x) => x !== v) : [...includes, v],
    );
  ...
  const Footer = (
    <ModalFooter
      leftSlot={
        ...
        >
          {t("dialog.noticePre")}{" "}
          <b style={{ color: "var(--fg-secondary)" }}>{TX.length}</b>
          {t("dialog.noticePost")}
        </span>
      }
      onCancel={onClose}
              ...
              >
                ...
                >
                  ...
                  {active && (
                    <CheckCircle2
                      size={14}
                      style={{ color: "var(--bg-brand)", marginLeft: "auto" }}
                    />
                  )}
                </div>
                <div
