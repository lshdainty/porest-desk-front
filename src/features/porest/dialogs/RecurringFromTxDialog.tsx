              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${active ? 'var(--mossy-500)' : 'var(--border-subtle)'}`,
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${selected ? 'var(--mossy-500)' : 'var(--border-subtle)'}`,
        borderRadius: 12,
        cursor: 'pointer',
    ...
    >
      <span
        ...
        style={{
          ...
          height: 16,
          borderRadius: 999,
          border: `2px solid ${selected ? 'var(--mossy-500)' : 'var(--border-default)'}`,
          background: selected ? 'var(--mossy-500)' : 'transparent',
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 999,
          border: 0,
          background: value ? 'var(--mossy-500)' : 'var(--border-default)',
          position: 'relative',
          cursor: 'pointer',
          padding: 0,
