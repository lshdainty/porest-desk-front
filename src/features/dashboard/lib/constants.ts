...
export const WIDGETS: Widget[] = [
  ...
  { id: 'monthly-budget', labelKey: 'widget.monthlyBudget', defaultH: 9, defaultW: 6, minW: 4, maxW: 12, minH: 7, maxH: 14 },
  { id: 'asset-overview', labelKey: 'widget.assetOverview', defaultH: 9, defaultW: 6, minW: 4, maxW: 12, minH: 7, maxH: 14 },
  ...
  // 가계부 신규 차트
  { id: 'payment-method', labelKey: 'widget.paymentMethod', defaultH: 9, defaultW: 6, minW: 4, maxW: 8, minH: 7, maxH: 14 },
  { id: 'daily-expense-calendar', labelKey: 'widget.dailyExpenseCalendar', defaultH: 8, defaultW: 6, minW: 4, maxW: 8, minH: 7, maxH: 12 },
  { id: 'savings-rate', labelKey: 'widget.savingsRate', defaultH: 9, defaultW: 6, minW: 4, maxW: 12, minH: 7, maxH: 14 },
