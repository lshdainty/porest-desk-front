...
const SECTIONS: SectionDef[] = [
  {
    id: "categories",
    labelKey: "sections.categories.label",
    icon: Tag,
    descKey: "sections.categories.desc",
  },
  {
    id: "accounts",
    labelKey: "sections.accounts.label",
    icon: CreditCard,
    descKey: "sections.accounts.desc",
  },
  {
    id: "budget",
    labelKey: "sections.budget.label",
    icon: FilePen,
    descKey: "sections.budget.desc",
  },
  {
    id: "goals",
    labelKey: "sections.goals.label",
    icon: PiggyBank,
    descKey: "sections.goals.desc",
  },
  {
    id: "recurring",
    labelKey: "sections.recurring.label",
    icon: Repeat,
    descKey: "sections.recurring.desc",
  },
  {
    id: "presets",
    labelKey: "sections.presets.label",
    icon: Bookmark,
    descKey: "sections.presets.desc",
  },
  {
    id: "calendar-share",
    labelKey: "sections.calendarShare.label",
    icon: CalendarCog,
    descKey: "sections.calendarShare.desc",
  },
  {
    id: "calendar-labels",
    labelKey: "sections.calendarLabels.label",
    icon: Tag,
    descKey: "sections.calendarLabels.desc",
  },
  {
    id: "todo-tags",
  ...
  },
  {
    ...
    icon: Palette,
    descKey: "sections.appearance.desc",
  },
  {
    id: "notifications",
    labelKey: "sections.notifications.label",
    icon: Bell,
    descKey: "sections.notifications.desc",
  },
  {
    id: "data",
    labelKey: "sections.data.label",
    icon: Download,
    descKey: "sections.data.desc",
  },
  {
    id: "account",
  ...
  {
    id: "hide-amounts",
    labelKey: "hideAmounts.label",
    icon: Eye,
    descKey: "hideAmounts.desc",
    hidden: true,
  },
  // 계정 > 보안에서 들어온다. 목록에는 안 나온다.
  {
    id: "devices",
    labelKey: "sections.devices.label",
    icon: Monitor,
    descKey: "sections.devices.desc",
    hidden: true,
    parent: "account",
  },
];
...
const SECTION_IDS: SectionId[] = SECTIONS.filter((s) => !s.externalUrl).map(
  (s) => s.id,
);
...
export const SettingsPage = () => {
  ...
  const renderBody = (m: boolean) => {
    ...
    switch (activeSection.id) {
      case "categories":
        return <CategoryManager mobile={m} reorderMode={m && catReorder} />;
      case "accounts":
        return <AccountManager mobile={m} />;
      case "budget":
        return <BudgetManager mobile={m} />;
      case "goals":
        return <SavingGoalManager mobile={m} />;
      case "recurring":
        return <RecurringManager mobile={m} />;
      case "presets":
        return <PresetManager mobile={m} />;
      case "calendar-share":
        return <CalendarShareSection mobile={m} />;
      ...
      case "notifications":
        return <NotificationsManager mobile={m} />;
      case "data":
        return <DataExportSection mobile={m} />;
      case "account":
        return (
          <AccountSection
            mobile={m}
            onOpenHideAmounts={() => changeSection("hide-amounts")}
            onOpenDevices={() => changeSection("devices")}
          />
        );
      case "hide-amounts":
        return (
          <HideAmountsSection
            mobile={m}
            onBack={() => changeSection("account")}
          />
        );
      case "devices":
        return <DevicesSection mobile={m} />;
      default:
  ...
  if (mobile) {
    ...
    if (section === "hide-amounts") {
      return (
        <HideAmountsSection mobile onBack={() => changeSection("account")} />
      );
    }
  ...
  return (
    <div style={{ padding: 0 }}>
      <div
        ...
        style={{ padding: "24px 28px 0", margin: 0, maxWidth: 1320 }}
      >
        <div>
          <h1>{t("page.title")}</h1>
...
function AccountSection({
  ...
  const nextBill = periodEnd
    ? (toLocalDateKey(periodEnd) ?? periodEnd.slice(0, 10))
    : null;
    ...
    >
      ...
      >
        ...
        {joinedAt && (
          ...
          >
            {t("account.joined", {
              date: isEn()
                ? joinedAt.toLocaleDateString("en", {
                    year: "numeric",
                    month: "short",
                  })
      ...
      <AccountGroup mobile={mobile} label={t("account.group.security")}>
        ...
        <AccountRow
          ...
          desc={
            <span className="num">
              {hiddenCount} / {ALL_HIDE_CARDS.length}
            </span>
          }
          right={
            <ChevronRight size={16} style={{ color: "var(--fg-tertiary)" }} />
        ...
        <AccountRow
          mobile={mobile}
          icon={
            <CalendarDays size={20} style={{ color: "var(--fg-secondary)" }} />
          }
      ...
      {/* 구독 관리 다이얼로그 */}
      {subOpen && (
        <SubscriptionDialog onClose={() => setSubOpen(false)} mobile={mobile} />
      )}
      {securitiesOpen && (
        <SecuritiesLinkDialog
          onClose={() => setSecuritiesOpen(false)}
          mobile={mobile}
        />
      )}
    </div>
