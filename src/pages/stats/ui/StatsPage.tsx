          ...
          >
            ...
            >
              ...
              {/* 도넛 구멍이 좁다(모바일 176 − 스트로크 28×2 = 120). 전체 자릿수를 쓰면
                  ...
                  차트 축과 같은 축약을 쓴다(1.2억). 정확한 금액은 바로 아래 범례가 갖고 있다.
                  전 구간 소수 한 자리다 — 11,881 을 "1만" 으로 내면 범례 합계와 16% 어긋난다(QA #38).
                  가장 긴 값이 "1,230.5만"(9자·20px 굵게 ≈ 90px)이라 구멍 120px 안에 든다(QA #73). */}
              <div
                className="val num"
