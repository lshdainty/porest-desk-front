...
export function SearchPage() {
  ...
  return (
    <div className="m-scroll" style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, color: 'var(--fg-tertiary)' }}>
      ...
      <div style={{ fontSize: 'var(--text-body-sm)', fontWeight: '500' }}>{t('searchComingSoon')}</div>
      <div style={{ fontSize: 'var(--text-caption)', color: 'var(--fg-tertiary)' }}>{t('searchComingSoonDesc')}</div>
    </div>
  )
}
