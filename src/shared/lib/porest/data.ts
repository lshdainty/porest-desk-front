...
export const CATEGORIES: Record<CategoryKey, CategoryDef> = {
  ...
  shopping: {
    ...
    bg: "oklch(0.96 0.035 340)",
  },
  living: {
    label: "생활·가공",
    icon: "home",
    color: "oklch(0.50 0.1 140)",
    bg: "oklch(0.96 0.025 135)",
  },
  medical: {
    label: "의료·건강",
    icon: "heart-pulse",
  ...
  leisure: {
    ...
    bg: "oklch(0.96 0.035 290)",
  },
  bill: {
    label: "공과·통신",
    icon: "receipt-text",
    color: "oklch(0.48 0.012 195)",
  ...
  edu: {
    ...
    bg: "oklch(0.96 0.03 210)",
  },
  saving: {
    label: "저축·투자",
    icon: "piggy-bank",
    color: "var(--color-chart-brown)",
    bg: "color-mix(in srgb, var(--color-chart-brown) 18%, transparent)",
  },
  income: {
    label: "수입",
    icon: "arrow-down-to-line",
    color: "var(--color-chart-green)",
    bg: "color-mix(in srgb, var(--color-chart-green) 18%, transparent)",
  },
};
...
export const NETWORTH_TREND = [
  14_200_000, 14_680_000, 15_120_000, 15_890_000, 16_340_000, 16_720_000,
  17_480_000, 18_100_000, 18_540_000, 19_120_000, 19_680_000, 20_410_800,
];
