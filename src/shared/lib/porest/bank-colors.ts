...
export const INVEST_CATEGORIES: BankCategory[] = [
  "증권사",
  "상품거래소",
  "가상자산",
];
...
export const CATEGORY_HOLDING_TYPE: Partial<
  Record<BankCategory, "STOCK" | "GOLD" | "CRYPTO">
> = {
  증권사: "STOCK",
  상품거래소: "GOLD",
  가상자산: "CRYPTO",
...
export const BANK_ENTRIES_BY_CATEGORY: Record<BankCategory, BankEntry[]> =
  BANK_ENTRIES.reduce(
    (acc, e) => {
