...
export const REGION_OPTIONS = [
  ...
  { value: 'America/New_York', ko: '미국 동부 (뉴욕)', en: 'US Eastern (New York)' },
  { value: 'America/Chicago', ko: '미국 중부 (시카고)', en: 'US Central (Chicago)' },
  { value: 'America/Denver', ko: '미국 산악 (덴버)', en: 'US Mountain (Denver)' },
  { value: 'America/Los_Angeles', ko: '미국 서부 (로스앤젤레스)', en: 'US Pacific (Los Angeles)' },
  { value: 'America/Sao_Paulo', ko: '브라질 (상파울루)', en: 'Brazil (Sao Paulo)' },
  { value: 'UTC', ko: 'UTC (협정 세계시)', en: 'UTC (Coordinated Universal Time)' },
] as const

/** 목록에 없는 값(가입 이후 목록이 바뀌었거나 직접 넣은 값)도 고를 수 있게 옵션으로 끼워준다. */
export const regionOptionsWith = (current: string | undefined) => {
  const base = REGION_OPTIONS as readonly { value: string; ko: string; en: string }[]
